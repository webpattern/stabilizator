...
class ModelCatalogProduct extends Model {
    ...
    public function getAllProducts($all_products_data) {

        $sql = "SELECT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id != (int)$all_products_data)";
